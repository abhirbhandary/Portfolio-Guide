...
|---|---|---|---|
| 🎵[Spotify Playlist](https://github.com/abhirbhandary/Python/blob/main/KMeans.ipynb) | Programming | Analysis of Spotify’s audio features to identify “similar songs”, as defined by humanly detectable criteria using K-Means method to create playlists.| - |    
